...
class Pac extends Connection{
    ...
    public function index(){
        ...
        $query=
        "SELECT 
        CAST(NET_AMOUNT AS FLOAT64) AS NET_AMOUNT, TRX_CODE, BUSINESS_DATE, TC_SUBGROUP, TC_GROUP, BILL_NO, FISCAL_BILL_NO, TRAN_ACTION_ID, ROOM, TAX_INCLUSIVE_YN, CAST(SUBSTR(BUSINESS_DATE,6,2)AS INT64) AS MONTH 
        FROM 
